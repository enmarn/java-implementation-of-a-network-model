...
public class DataLinkLayerUtil  {
	...
	public static String toParentTransparentBitStream(String bitstream) {
		return ParentTransmissionUtil.toParentTransparentBitString(bitstream); 
	}
	/**
	 * @param 由物理层传输的透明的比特流
	 * @return 去透明化的比特流
	 * @throws Exception 
	 */
	public static String toOriginalBitStream(String bitstream) throws Exception {
		return ParentTransmissionUtil.toOriginalBitString(bitstream);
	}
}
